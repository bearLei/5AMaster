...
package com.puti.education.widget.timeWidget.wheelview;
...
import com.puti.education.widget.timeWidget.wheeladapter.WheelViewAdapter;
...
public class WheelView extends View {
	...
	// Wheel drawables
	private int wheelBackground = com.puti.education.R.drawable.wheel_bg;
	private int wheelForeground = com.puti.education.R.drawable.wheel_val;
	...
	private void drawCenterRect(Canvas canvas) {
		...
		paint.setColor(getResources().getColor(com.puti.education.R.color.province_line_border));
		// 设置线宽

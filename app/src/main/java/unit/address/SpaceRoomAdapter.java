...
public class SpaceRoomAdapter extends BaseAdapter {

    private Context mContext;
    private ArrayList<Room> mData;

    public SpaceRoomAdapter(Context mContext, ArrayList<Room> mData) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.title.setText(mData.get(position).getRoom());

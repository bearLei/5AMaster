...
public class PhotoPickerActivity extends AppCompatActivity {
    ...
    private final static int REQUEST_CAMARE_CODE = 1;
    private final static int REQEUST_WRITE_CODE = 2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (requestPermissions(Manifest.permission.WRITE_EXTERNAL_STORAGE,REQEUST_WRITE_CODE,R.string.msg_write) == 1){
            ...
            case REQUEST_CAMARE_CODE:
                {
                    if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED ) {
                        ...
                        rationaleDialog(R.string.msg_camera);
                    }
                }
                break;
            case REQEUST_WRITE_CODE:
                {
                    if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                        ...
                        //针对用户点击了 “禁止后不再询问”勾选框
                        rationaleDialog(R.string.msg_write);
                    }
                }
                break;
        }
     ...
     * @return -1没有权限 1有权限
     */
    private int requestPermissions(String permissionName,int requestCode,int dialogMsgId) {
    ...
    private void startToSettingActivity(){
        Uri packageURI = Uri.parse("package:" + PhotoPickerActivity.this.getPackageName());
